...
namespace ProyectoFinal_PG.Servicios
{
    public class MensajesDeErrorIdentity: IdentityErrorDescriber
    {
        ...
        public override IdentityError LoginAlreadyAssociated() { return new IdentityError { Code = nameof(LoginAlreadyAssociated), Description = "Un empleado con ese codigo ya existe." }; }
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"El codigo de empleado '{userName}' es inválido. Solo puede contener números." }; }
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"El codigo '{userName}' ya existe, por favor ingrese un codigo diferente." }; }
